...
Route::prefix('public/shop')->group(function () {
    Route::get('surcharges',    [PublicOrderController::class, 'surcharges']);
    Route::post('check-email',  [PublicOrderController::class, 'checkEmail'])->middleware('throttle:20,1');
    Route::post('verify-login', [PublicOrderController::class, 'verifyLogin'])->middleware('throttle:10,1');
